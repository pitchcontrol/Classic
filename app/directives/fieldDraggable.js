    ...
    var fieldDraggable = function ($rootScope, diagramService) {
        function link(scope, element, attr) {
            ...
            var refresh = function () {
                scope.field.geometry.x = element.prop('offsetLeft');
                scope.field.geometry.y = element.prop('offsetTop');
                ...
                if (scope.field.associationObj && scope.field.associationObj.relation) {
                    scope.field.associationObj.relation.setEnd(scope.field.geometry.right.x + scope.field.entity.geometry.x-diagramService.geometry.offsetX, scope.field.geometry.right.y + scope.field.entity.geometry.y-diagramService.geometry.offsetY);
                }
